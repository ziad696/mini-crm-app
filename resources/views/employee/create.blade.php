                        ...
                        <div class="col-7">
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" id="last_name" placeholder="Nama Belakang" name="last_name" value="{{old('last_name')}}" class="form-control @error('last_name') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="phone" placeholder="No. Telepon/Hp" name="phone" value="{{old('phone')}}" class="form-control @error('phone') is-invalid @enderror">
