                        ...
                        <div class="col-7">
                            <div class="form-group row">
                                <div class="col-6">
                                    ...
                                    <input type="text" id="first_name" placeholder="{{ __('adminlte::adminlte.first_name') }}" name="first_name" value="{{old('first_name')}}" class="form-control @error('first_name') is-invalid @enderror">
                                    @error('first_name') <span class="text-danger">{{$message}}</span> @enderror
                                </div>
                                <div class="col-6">
                                    <label for="name">&nbsp;</label>
                                    <input type="text" id="last_name" placeholder="{{ __('adminlte::adminlte.last_name') }}" name="last_name" value="{{old('last_name')}}" class="form-control @error('last_name') is-invalid @enderror">
                                    @error('last_name') <span class="text-danger">{{$message}}</span> @enderror
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="email">E-Mail</label>
                                <input type="text" id="email" placeholder="E-mail" name="email" value="{{old('email')}}" class="form-control @error('email') is-invalid @enderror">
                                @error('email') <span class="text-danger">{{$message}}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label for="phone">{{ __('adminlte::adminlte.phone') }}</label>
                                <input type="text" id="phone" placeholder="{{ __('adminlte::adminlte.phone') }}" name="phone" value="{{old('phone')}}" class="form-control @error('phone') is-invalid @enderror">
